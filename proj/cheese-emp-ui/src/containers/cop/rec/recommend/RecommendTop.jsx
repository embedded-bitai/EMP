...
const Row = tw.div`flex items-center text-center flex-col lg:flex-row`;
// const Column = tw.div`lg:w-1/2`;
const TextColumn = tw.div`text-center lg:text-left`;
// const IllustrationColumn = tw(Column)`mt-16 lg:mt-0 lg:ml-16`;
const Heading = tw(SectionHeading)`max-w-3xl lg:max-w-4xl lg:text-center leading-tight text-black  text-center`;
